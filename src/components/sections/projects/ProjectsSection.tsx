...
export function ProjectsSection() {
  return (
    <section className="relative py-32 z-20" id="projects">
      <Container>
          ...
          <div className="group relative w-full rounded-3xl border border-white/10 bg-black/60 backdrop-blur-xl shadow-2xl overflow-hidden transition-all duration-500 hover:border-white/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 relative z-10">
              ...
              <div className="relative h-[400px] lg:h-auto bg-white/5 border-b lg:border-b-0 lg:border-r border-white/5 overflow-hidden flex items-center justify-center p-8 perspective-[1000px]">
                ...
                {/* Browser Window */}
                <div className="relative w-full max-w-md aspect-[4/3] bg-[#0a0a0a] rounded-xl border border-white/10 shadow-2xl transform transition-transform duration-700 ease-out group-hover:rotate-y-[-5deg] group-hover:rotate-x-[5deg] group-hover:scale-105">
                  <div className="h-8 border-b border-white/10 flex items-center px-4 gap-2 bg-white/5">
                    <div className="w-2.5 h-2.5 rounded-full bg-red-500/50"></div>
                    <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/50"></div>
                    <div className="w-2.5 h-2.5 rounded-full bg-green-500/50"></div>
                  </div>
                  <div className="relative h-full w-full bg-[#050505] flex flex-col items-center justify-center text-gray-600 p-6 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-[2px]">
                      <span className="text-sm font-mono text-blue-400 border border-blue-500/30 bg-blue-500/10 px-3 py-1 rounded-full">
                        Dashboard Interface
                      </span>
                    </div>
                  </div>
          ...
          <div className="group relative w-full rounded-3xl border border-white/10 bg-black/60 backdrop-blur-xl shadow-2xl overflow-hidden transition-all duration-500 hover:border-white/30 hover:shadow-[0_0_50px_rgba(255,255,255,0.05)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 relative z-10">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                {/* CTA Button */}
                <div>
                  <button className="group relative inline-flex items-center gap-3 px-6 py-3 bg-white text-black rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]">
